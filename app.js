...
const I18N={
fr:{today:"AUJOURD’HUI",group:"Groupe",servers:"serveurs",loading:"Chargement…",confirmed:"Confirmé",forecast:"Prévision à vérifier par capture",botConfirmed:"Dernière confirmation",refresh:"Actualiser",searchTitle:"Rechercher un serveur",search:"Rechercher",localRule:"Géré séparément : Shiny mardi et samedi.",howTitle:"Comment la mise à jour fonctionne",howText:"La page récupère la source de données du Radar Shiny existant. Si aucune confirmation n’est disponible pour aujourd’hui, elle affiche automatiquement le groupe prévu selon le cycle A → C → B.",syncLive:"Source Radar Shiny consultée",syncFallback:"Mode secours : données locales utilisées",notFound:"Serveur non présent dans les groupes Shiny suivis.",serverGroup:"Le serveur {s} appartient au groupe {g}.",todayYes:"Il est dans la liste d’aujourd’hui.",todayNo:"Il n’est pas dans la liste d’aujourd’hui.",last:"Dernière confirmation : {d} · Groupe {g} · {n} serveurs"},
de:{today:"HEUTE",group:"Gruppe",servers:"Server",loading:"Laden…",confirmed:"Bestätigt",forecast:"Vorhersage per Screenshot zu prüfen",botConfirmed:"Letzte Bestätigung",refresh:"Aktualisieren",searchTitle:"Server suchen",search:"Suchen",localRule:"Separat verwaltet: Shiny Dienstag und Samstag.",howTitle:"So funktioniert die Aktualisierung",howText:"Die Seite liest die Datenquelle des bestehenden Shiny Radars. Fehlt für heute eine Bestätigung, wird automatisch die erwartete Gruppe nach dem Zyklus A → C → B angezeigt.",syncLive:"Shiny-Radar-Quelle abgerufen",syncFallback:"Notfallmodus: lokale Daten verwendet",notFound:"Server ist in den verfolgten Shiny-Gruppen nicht vorhanden.",serverGroup:"Server {s} gehört zur Gruppe {g}.",todayYes:"Er steht auf der heutigen Liste.",todayNo:"Er steht heute nicht auf der Liste.",last:"Letzte Bestätigung: {d} · Gruppe {g} · {n} Server"},
en:{today:"TODAY",group:"Group",servers:"servers",loading:"Loading…",confirmed:"Confirmed",forecast:"Forecast — verify by screenshot",botConfirmed:"Latest confirmation",refresh:"Refresh",searchTitle:"Search a server",search:"Search",localRule:"Handled separately: Shiny Tuesday and Saturday.",howTitle:"How updates work",howText:"This page reads the existing Shiny Radar data source. If there is no confirmation for today, it automatically shows the expected group using the A → C → B cycle.",syncLive:"Shiny Radar source checked",syncFallback:"Fallback mode: local data in use",notFound:"Server is not present in the tracked Shiny groups.",serverGroup:"Server {s} belongs to group {g}.",todayYes:"It is on today’s list.",todayNo:"It is not on today’s list.",last:"Latest confirmation: {d} · Group {g} · {n} servers"},
ro:{today:"ASTĂZI",group:"Grupa",servers:"servere",loading:"Se încarcă…",confirmed:"Confirmat",forecast:"Previziune de verificat prin captură",botConfirmed:"Ultima confirmare",refresh:"Actualizează",searchTitle:"Caută un server",search:"Caută",localRule:"Gestionat separat: Shiny marți și sâmbătă.",howTitle:"Cum funcționează actualizarea",howText:"Pagina citește sursa de date a Radarului Shiny existent. Dacă azi nu există confirmare, afișează automat grupa probabilă după ciclul A → C → B.",syncLive:"Sursa Radar Shiny consultată",syncFallback:"Mod de rezervă: date locale",notFound:"Serverul nu apare în grupele Shiny urmărite.",serverGroup:"Serverul {s} aparține grupei {g}.",todayYes:"Este în lista de azi.",todayNo:"Nu este în lista de azi.",last:"Ultima confirmare: {d} · Grupa {g} · {n} servere"},
uk:{today:"СЬОГОДНІ",group:"Група",servers:"серверів",loading:"Завантаження…",confirmed:"Підтверджено",forecast:"Прогноз — перевірити скриншотом",botConfirmed:"Останнє підтвердження",refresh:"Оновити",searchTitle:"Пошук сервера",search:"Шукати",localRule:"Окремо: Shiny у вівторок і суботу.",howTitle:"Як працює оновлення",howText:"Сторінка читає джерело даних існуючого Shiny Radar. Якщо на сьогодні немає підтвердження, автоматично показується очікувана група за циклом A → C → B.",syncLive:"Джерело Shiny Radar перевірено",syncFallback:"Резервний режим: локальні дані",notFound:"Сервера немає у відстежуваних Shiny-групах.",serverGroup:"Сервер {s} належить до групи {g}.",todayYes:"Він є у сьогоднішньому списку.",todayNo:"Його немає у сьогоднішньому списку.",last:"Останнє підтвердження: {d} · Група {g} · {n} серверів"},
ko:{today:"오늘",group:"그룹",servers:"서버",loading:"불러오는 중…",confirmed:"확인됨",forecast:"예상 — 캡처 확인 필요",botConfirmed:"최근 확인",refresh:"새로고침",searchTitle:"서버 검색",search:"검색",localRule:"별도 관리: 화요일 / 토요일 Shiny.",howTitle:"업데이트 방식",howText:"이 페이지는 기존 Shiny Radar 데이터 소스를 읽습니다. 오늘 확인 데이터가 없으면 A → C → B 주기에 따라 예상 그룹을 자동 표시합니다.",syncLive:"Shiny Radar 소스 확인됨",syncFallback:"백업 모드: 로컬 데이터 사용",notFound:"추적 중인 Shiny 그룹에 없는 서버입니다.",serverGroup:"서버 {s}는 그룹 {g}에 속합니다.",todayYes:"오늘 목록에 있습니다.",todayNo:"오늘 목록에 없습니다.",last:"최근 확인: {d} · 그룹 {g} · 서버 {n}개"},
hr:{today:"DANAS",group:"Grupa",servers:"servera",loading:"Učitavanje…",confirmed:"Potvrđeno",forecast:"Predviđanje — provjeriti snimkom",botConfirmed:"Zadnja potvrda",refresh:"Osvježi",searchTitle:"Pronađi server",search:"Traži",localRule:"Odvojeno: Shiny utorkom i subotom.",howTitle:"Kako radi ažuriranje",howText:"Stranica čita izvor podataka postojećeg Shiny Radara. Ako danas nema potvrde, automatski prikazuje očekivanu grupu po ciklusu A → C → B.",syncLive:"Izvor Shiny Radara provjeren",syncFallback:"Rezervni način: lokalni podaci",notFound:"Server nije u praćenim Shiny grupama.",serverGroup:"Server {s} pripada grupi {g}.",todayYes:"Nalazi se na današnjem popisu.",todayNo:"Nije na današnjem popisu.",last:"Zadnja potvrda: {d} · Grupa {g} · {n} servera"},
pt:{today:"HOJE",group:"Grupo",servers:"servidores",loading:"A carregar…",confirmed:"Confirmado",forecast:"Previsão — confirmar por captura",botConfirmed:"Última confirmação",refresh:"Atualizar",searchTitle:"Procurar um servidor",search:"Procurar",localRule:"Gerido separadamente: Shiny terça e sábado.",howTitle:"Como funciona a atualização",howText:"A página lê a fonte de dados do Shiny Radar existente. Se não houver confirmação para hoje, mostra automaticamente o grupo previsto segundo o ciclo A → C → B.",syncLive:"Fonte Shiny Radar consultada",syncFallback:"Modo de segurança: dados locais",notFound:"Servidor não presente nos grupos Shiny acompanhados.",serverGroup:"O servidor {s} pertence ao grupo {g}.",todayYes:"Está na lista de hoje.",todayNo:"Não está na lista de hoje.",last:"Última confirmação: {d} · Grupo {g} · {n} servidores"}
};
