...
hr:{today:"DANAS",group:"Grupa",servers:"servera",loading:"Učitavanje…",confirmed:"Bot potvrđeno",forecast:"Predviđanje — provjeriti snimkom",botConfirmed:"Zadnja Bot potvrda",refresh:"Osvježi",searchTitle:"Pronađi server",search:"Traži",localRule:"Odvojeno: Shiny utorkom i subotom.",howTitle:"Kako radi ažuriranje",howText:"Stranica čita izvor podataka postojećeg Shiny Radara. Ako danas nema potvrde, automatski prikazuje očekivanu grupu po ciklusu A → C → B.",syncLive:"Izvor Shiny Radara provjeren",syncFallback:"Rezervni način: lokalni podaci",notFound:"Server nije u praćenim Shiny grupama.",serverGroup:"Server {s} pripada grupi {g}.",todayYes:"Nalazi se na današnjem popisu.",todayNo:"Nije na današnjem popisu.",last:"Zadnja potvrda: {d} · Grupa {g} · {n} servera"},
